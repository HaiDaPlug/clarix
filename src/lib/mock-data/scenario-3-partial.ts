...
export const scenario3: ReportData = {
  ...
  kpiSnapshot: {
    ...
    metrics: [
      ...
      { label: "Genomsnittlig position", value: 14.2, previousValue: 16.1, unit: "number", trend: "up", trendGood: false },
    ],
  },
  ...
  seoOverview: {
    ...
    avgPosition: { label: "Genomsnittlig position", value: 14.2, previousValue: 16.1, unit: "number", trend: "up", trendGood: false },
    avgCtr: { label: "Genomsnittlig CTR", value: 3.6, previousValue: 3.5, unit: "percent", trend: "up", trendGood: true },
    timeSeries: [
