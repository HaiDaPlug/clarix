        ...
        <div className="lg:col-span-7">
          ...
          >
            {loading ? (
              ...
              <>
                <p
                  className="text-[1.25rem] font-medium leading-[1.45] tracking-normal sm:text-[1.7rem]"
                ...
                <div className="mt-6">
                  <Link
                    href={reportHref}
                    className="inline-flex items-center gap-2.5 rounded-full border border-white/70 bg-white/60 px-5 py-2.5 text-sm font-semibold shadow-sm backdrop-blur-sm transition hover:bg-white/80"
                    style={{ color: "oklch(0.15 0.02 290)", textDecoration: "none" }}
                  >
