      ...
      <div className="grid grid-cols-2 gap-2.5">
        {d.topChannels.map((c, i) => {
          ...
          return (
            <div
              key={c.name}
              className={`relative flex flex-col rounded-2xl border bg-background/90 p-4 shadow-[0_2px_4px_rgba(15,23,42,0.03),0_14px_36px_-22px_rgba(15,23,42,0.18)] ${
            ...
            >
              ...
              <div className="mt-2.5 flex items-end justify-between gap-3">
                <div>
                  <p className="font-display text-[34px] font-semibold leading-none tabular-nums">{c.pct}%</p>
                  <p className="mt-1 text-[18px] tabular-nums text-foreground">{fmtNum(c.visits)} besök</p>
                </div>
